...
- Name: route-protection.spec.ts >> Route Protection >> public can access register page
- Location: src/tests/e2e/route-protection.spec.ts:21:7

# Error details

```
Error: page.goto: net::ERR_TOO_MANY_REDIRECTS at http://localhost:3000/kk/register
Call log:
  - navigating to "http://localhost:3000/kk/register", waiting until "domcontentloaded"
