...
- Name: route-protection.spec.ts >> Route Protection >> public can access landing page
- Location: src/tests/e2e/route-protection.spec.ts:6:7

# Error details

```
Error: page.goto: net::ERR_TOO_MANY_REDIRECTS at http://localhost:3000/kk
Call log:
  - navigating to "http://localhost:3000/kk", waiting until "domcontentloaded"
