...
- Name: route-protection.spec.ts >> Route Protection >> public can access login page
- Location: src/tests/e2e/route-protection.spec.ts:12:7

# Error details

```
Error: page.goto: net::ERR_TOO_MANY_REDIRECTS at http://localhost:3000/kk/login
Call log:
  - navigating to "http://localhost:3000/kk/login", waiting until "domcontentloaded"
